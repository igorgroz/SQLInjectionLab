...
const FetchUserClothesGraphQLPage = () => {
  ...
  return (
    <div>
      <hr />
      <h1>User Clothes Information from Anonymous GraphQL API</h1>
      ...
      <details open>
        ...
        <div>
          ...
          />
          <button onClick={handleAddCloth}>Add Cloth (Anonymous GraphQL)</button>
        </div>
      </details>
      ...
      <details open>
        ...
        <div>
          ...
          />
          <button onClick={handleRemoveCloth}>Remove Cloth (Anonymous GraphQL)</button>
        </div>
      </details>
